...
from app.referral_system.utils import get_ref_code, send_code_to_mail
from app.referral_system.schemas import CreateReferralCode, ReferralCode, Referrer
...
async def delete_ref_code(
    ...
    return JSONResponse(
        status_code=204,
        content={"success": True, "description": f"referral code {code.code} deleted"}
    )
...
async def get_ref_code(
    ...
    ref_code = ReferralCode(
        ...
        action_time_day=action_time_code.days
    )
